...
def install(use_cuda, use_nccl):
    ...
    setup(
        ...
        include_dirs=['./hexa_moe/include'],
        ext_modules=[
            extension(
                'hexa_moe_cuda',
                ['./hexa_moe/torch/hexa_moe_ops.cpp', './hexa_moe/kernels/shared_cuda_core.cu', \
                 './hexa_moe/kernels/esmm_full.cu', './hexa_moe/kernels/fused_ops_full.cu', \
                 './hexa_moe/kernels/esmm_half.cu', './hexa_moe/kernels/fused_ops_half.cu', \
                 './hexa_moe/kernels/esmm_mix.cu', './hexa_moe/kernels/fused_ops_mix.cu'],
            )
        ],
        cmdclass={
